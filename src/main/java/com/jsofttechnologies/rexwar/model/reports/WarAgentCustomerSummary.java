...
@Entity
@XmlRootElement
@IdClass(WarAgentCustomerSummaryID.class)
@NamedStoredProcedureQueries({
        @NamedStoredProcedureQuery(
                name = WarAgentCustomerSummary.PROCEDURE_AGENT_CUSTOMER_SUMMARY,
                procedureName = WarAgentCustomerSummary.PROCEDURE_AGENT_CUSTOMER_SUMMARY,
                resultClasses = {WarAgentCustomerSummary.class},
                parameters = {
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = WarAgentCustomerSummary.IN_CUSTOMER_ID, type = Long.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = WarAgentCustomerSummary.IN_SCHOOL_YEAR_ID, type = Long.class)
                }
        )
})
public class WarAgentCustomerSummary implements Serializable {

    public static final String PROCEDURE_AGENT_CUSTOMER_SUMMARY = "agent_customer_summary";
